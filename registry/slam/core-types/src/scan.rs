//! Scan data as consumed by a 2D SLAM pipeline.
//!
...
/// sensor-native units (e.g. the RPLIDAR's millimetres and clockwise degrees)
/// *before* constructing this type, and never convert again.
///
/// This struct is deliberately message-shaped (public fields, no internal
/// state) so a bridge can convert it to/from ROS2 or other middleware
/// messages trivially.
