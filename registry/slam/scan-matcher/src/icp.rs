...
use super::super::error::SlamError;
use super::super::pose::{Pose2, normalize_angle};
use super::super::scan::ScanCloud;
use super::{MatchResult, ScanMatcher};
...
/// feature spacing; diverges silently otherwise. When no good guess exists
/// (e.g. no odometry), use a correlative matcher — see the full
/// `olivaw-slam` crate, which provides one with bounded runtime.
...
#[cfg(test)]
mod tests {
    use super::super::test_scenes::{noisy_room_scan, room_scan};
    use super::*;
